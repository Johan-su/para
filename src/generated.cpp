...
# 1 "../src/meta.cpp" 2
# 61 "../src/meta.cpp"
enum NodeType { NODE_INVALID, NODE_PROGRAM, NODE_STATEMENT, NODE_NUMBER, NODE_FUNCTION, NODE_FUNCTIONDEF, NODE_VARIABLE, NODE_VARIABLEDEF, NODE_ADD, NODE_SUB, NODE_MUL, NODE_DIV, NODE_UNARYADD, NODE_UNARYSUB, NODE_OPENPAREN, }; enum ItemType { ITEM_INVALID, ITEM_VARIABLE, ITEM_FUNCTION, };
# 71 "../src/meta.cpp"
const char *str_NodeType[] = { "NODE_INVALID", "NODE_PROGRAM", "NODE_STATEMENT", "NODE_NUMBER", "NODE_FUNCTION", "NODE_FUNCTIONDEF", "NODE_VARIABLE", "NODE_VARIABLEDEF", "NODE_ADD", "NODE_SUB", "NODE_MUL", "NODE_DIV", "NODE_UNARYADD", "NODE_UNARYSUB", "NODE_OPENPAREN", }; const char *str_ItemType[] = { "ITEM_INVALID", "ITEM_VARIABLE", "ITEM_FUNCTION", };
# 80 "../src/meta.cpp"
